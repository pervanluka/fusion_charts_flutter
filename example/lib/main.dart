...
import 'zoom_pan_showcase.dart';
import 'live_chart_showcase.dart';
            ...
            children: [
              ...
              _ShowcaseCard(
                ...
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const LabelGeneratorShowcase(),
                  ),
                ),
              ),
              _ShowcaseCard(
              ...
              _ShowcaseCard(
                ...
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const ZoomPanShowcase()),
                ),
              ),
              _ShowcaseCard(
                title: 'Live Charts',
                ...
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const LiveChartShowcase()),
                ),
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return FusionLineChart(
      series: [
        FusionLineSeries(
          dataPoints: [
            FusionDataPoint(0, 30, label: 'Mon'),
            FusionDataPoint(1, 50, label: 'Tue'),
            FusionDataPoint(2, 40, label: 'Wed'),
            FusionDataPoint(3, 65, label: 'Thu'),
            FusionDataPoint(4, 55, label: 'Fri'),
            FusionDataPoint(5, 80, label: 'Sat'),
          ],
          color: const Color(0xFF8B5CF6),
          lineWidth: 2.5,
        ),
      ...
      config: FusionChartConfiguration(
        ...
        crosshairBehavior: FusionCrosshairConfiguration(
          ...
          // Format X-axis label using the day name
          xLabelFormatter: (value, point) =>
              point?.label ?? 'Day ${value.toInt() + 1}',
          // Format Y-axis label as currency
          yLabelFormatter: (value, point) => '\$${value.toStringAsFixed(0)}',
        ),
      ),
    );
  }
